...
var App = React.createClass({
    getInitialState: function(){
      return {hand: ["ace_of_hearts", "ace_of_diamonds", "queen_of_clubs", "queen_of_hearts", "queen_of_spades"]};
    },
      ...
      <div>
        ...
        <div className="row">
          <div className="col-sm-2">
            <h1><a href="#" onClick={this.btnClicked} className="btn btn-success">Deal</a></h1>
          </div>
